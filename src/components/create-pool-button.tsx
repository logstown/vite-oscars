...
export function CreatePoolButton({ currentUser }: { currentUser: DbUser }) {
  ...
  return (
    <Popover showArrow offset={10} placement="bottom" isOpen={isOpen} onOpenChange={(open) => setIsOpen(open)}>
      <PopoverTrigger>
        <Button
          size="lg"
      ...
      <PopoverContent>
        <Form validationBehavior="native" onSubmit={onSubmit} className="p-4 w-full gap-6 items-end">
          <Input label="Name" isRequired name="name" autoFocus variant="bordered" />
